function [ranks, ix] = backendNotParallel_faces (query, ...
    model, VV, means, covariances, priors, W, upd_FVs_set)
...
distances = sqrt(sum((upd_FVs_set - repmat(upd_FVs, 1, size(upd_FVs_set, 2))) .^ 2));
